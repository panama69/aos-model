...
public class ApplicationModel extends AppModelBase {		private SPEAKERS SPEAKERS;
	private TABLETS TABLETS;
	private TABLET TABLET;
	private ADD_TO_CART ADD_TO_CART;
	private CHECK_OUT_CART CHECK_OUT_CART;
	...
	public ApplicationModel(TestObject contextTestObject) throws GeneralLeanFtException
	{
		setName("ApplicationModel");
				SPEAKERS = new SPEAKERS(contextTestObject, this);
		TABLETS = new TABLETS(contextTestObject, this);
		TABLET = new TABLET(contextTestObject, this);
		ADD_TO_CART = new ADD_TO_CART(contextTestObject, this);
		CHECK_OUT_CART = new CHECK_OUT_CART(contextTestObject, this);
		CHECK_OUT = new CHECK_OUT(contextTestObject, this);
		...
		public TABLETS TABLETS() { return TABLETS; }
		public TABLET TABLET() { return TABLET; }
		public ADD_TO_CART ADD_TO_CART() { return ADD_TO_CART; }
		public CHECK_OUT_CART CHECK_OUT_CART() { return CHECK_OUT_CART; }
		public CHECK_OUT CHECK_OUT() { return CHECK_OUT; }
	...
	public class TABLETS extends LinkNodeBase
	{

		
								public TABLETS(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
	...
	public class TABLET extends ImageNodeBase
	{

		
								public TABLET(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
	...
	public class ADD_TO_CART extends ButtonNodeBase
	{

		
								public ADD_TO_CART(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
	...
	public class CHECK_OUT_CART extends WebElementNodeBase
	{

		
								public CHECK_OUT_CART(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
		...
		protected com.hp.lft.sdk.web.WebElementDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.WebElementDescription.Builder().xpath("//*[@id=\"menuCart\"]").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class CHECK_OUT extends ButtonNodeBase
	{

		
								public CHECK_OUT(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
	...
	public class REMOVE extends WebElementNodeBase
	{
	...
	public class CONTINUE_SHOPPING extends LinkNodeBase
	{

		
								public CONTINUE_SHOPPING(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
	...
	public class SPEAKER extends ImageNodeBase
	{

		
								public SPEAKER(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
